...
> This extension wraps [Banana Codex](https://github.com/AgriciDaniel/banana-codex)
...
4. Configure the MCP server in `./.mcp.json`
...
This removes the skill and agent. If you also use [Banana Codex](https://github.com/AgriciDaniel/banana-codex),
